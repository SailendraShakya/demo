...
/**
 * @file
 * Contains \Drupal\dg_offices\Plugin\DsField\AddressMap.
 */

namespace Drupal\dg_offices\Plugin\DsField;
...
class AddressMap extends DsFieldBase {
  ...
  public function build() {
    ...
    return [
      ...
      '#attached' => ['library' => ['dg_offices/address_map']],
      '#icon' => $icon
    ];
  }
